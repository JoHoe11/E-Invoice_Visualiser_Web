...
export function renderCII(i) {
  ...
  <div class="invoice-preview">
    ...
    <div class="header">
      ...
      <div style="text-align:right;">
        <p>
          ...
          ${renderIf("USt-ID", i.käufer.ustid)}
          ${renderIf("Kontakt", i.käufer.contactName)}
          ${renderIf("Tel", i.käufer.contactTel)}
          ${renderIf("E-Mail", i.käufer.contactEmail)}
        </p>
      </div>
    </div>
    ...
    <div class="summary">
      ${renderIf("Netto",  i.netto  + " " + i.währung)}
      ${renderIf("Steuer", i.steuer + " " + i.währung)}
      ${renderIf("Brutto", i.brutto + " " + i.währung)}
    </div>
